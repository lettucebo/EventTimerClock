...
### Fixed
- Improved dropdown option readability in dark mode
  - Added explicit background color (--bg-primary) for select options
  - Added explicit text color (--text-primary) for select options
  - Fixed contrast issues in language and theme selector dropdowns
...
[1.0.5]: https://github.com/lettucebo/EventTimerClock/compare/1.0.2...1.0.5
